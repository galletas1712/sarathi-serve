...
from sarathi.core.scheduler.fcfs_disagg_emulation_scheduler import (
    FCFSDisaggEmulationScheduler,
)
...
SchedulerRegistry.register(
    SchedulerType.FCFS_DISAGG_EMULATION, FCFSDisaggEmulationScheduler
)
SchedulerRegistry.register(
